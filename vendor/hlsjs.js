// Source: https://github.com/benjipott/videojs-hlsjs
/*! videojs-hls - v0.0.0 - 2015-9-24
 * Copyright (c) 2015 benjipott
 * Licensed under the Apache-2.0 license. */
(function (window, videojs, Hls, document) {
  'use strict';
  /**
  ...
  */
  ...
  var Hlsjs = videojs.extend(Html5, {
    constructor: function (options) {
      this.hlsConfig = {
        debug: options.debug,
        xhrSetup: options.xhrSetup,
      };
      Tech.call(this, options);
    },
    createEl : function () {
      this.hls_ = new Hls(this.hlsConfig);
    ...
    seekable: function () {
      return this.player().el().seekable;
    },
